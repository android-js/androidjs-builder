...
.method protected doOpen()V
    ...
    invoke-virtual {p0, v7, v8}, Lio/socket/engineio/client/transports/WebSocket;->emit(Ljava/lang/String;[Ljava/lang/Object;)Lio/socket/emitter/Emitter;

    .line 41
    move-object v5, p0

    .line 42
    .local v5, "self":Lio/socket/engineio/client/transports/WebSocket;
    iget-object v7, p0, Lio/socket/engineio/client/transports/WebSocket;->webSocketFactory:Lokhttp3/WebSocket$Factory;
    ...
    .end local v2    # "factory":Lokhttp3/WebSocket$Factory;
    ...
    .restart local v2    # "factory":Lokhttp3/WebSocket$Factory;
    :cond_2
    ...
    new-instance v7, Lio/socket/engineio/client/transports/WebSocket$1;

    invoke-direct {v7, p0, v5}, Lio/socket/engineio/client/transports/WebSocket$1;-><init>(Lio/socket/engineio/client/transports/WebSocket;Lio/socket/engineio/client/transports/WebSocket;)V

    invoke-interface {v2, v4, v7}, Lokhttp3/WebSocket$Factory;->newWebSocket(Lokhttp3/Request;Lokhttp3/WebSocketListener;)Lokhttp3/WebSocket;

    move-result-object v7

    iput-object v7, p0, Lio/socket/engineio/client/transports/WebSocket;->ws:Lokhttp3/WebSocket;
...
.method protected write([Lio/socket/engineio/parser/Packet;)V
    ...
    .line 118
    new-instance v0, Lio/socket/engineio/client/transports/WebSocket$2;

    invoke-direct {v0, p0, v2}, Lio/socket/engineio/client/transports/WebSocket$2;-><init>(Lio/socket/engineio/client/transports/WebSocket;Lio/socket/engineio/client/transports/WebSocket;)V
    ...
    invoke-direct {v6, p0, v2, v3, v0}, Lio/socket/engineio/client/transports/WebSocket$3;-><init>(Lio/socket/engineio/client/transports/WebSocket;Lio/socket/engineio/client/transports/WebSocket;[ILjava/lang/Runnable;)V
